...
import { h as xe, c as z } from './render-CZGCd43d.js';
...
function De({ fallbackTag: e, useDisableForRouterLinkProps: t = !0 } = {}) {
  const a = U(),
    ...
    p = o(() => s.value === !0 && b.value !== -1 && Ke(l.$route.params, h.value.params)),
    d = o(
      () =>
        p.value === !0 &&
        b.value === l.$route.matched.length - 1 &&
        Ne(l.$route.params, h.value.params),
    ),
    x = o(() =>
      s.value === !0
        ? d.value === !0
    ...
    return (
      ...
      () => {
        ...
        return (
          ...
          pe(v(h.value, $.value, m), [[Ae, _.value, void 0, B.value]])
        );
      }
    );
  },
});
export { Y as Q, et as a, De as b, Pe as c, nt as d, Ze as g, tt as u, ze as v };
