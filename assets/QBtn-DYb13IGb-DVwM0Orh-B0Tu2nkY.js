...
import { l as z, a as xe } from './render-DAqPa2vd-D0yqDhMx-4SFXGzvt.js';
const U = { xs: 18, sm: 24, md: 32, lg: 38, xl: 46 },
  ae = { size: String };
function le(e, t = U) {
  return i(() =>
...
const J = '0 0 24 24',
  ...
  $e = new RegExp('^(' + Object.keys(oe).join('|') + ')'),
  V = new RegExp('^(' + Object.keys(se).join('|') + ')'),
  we = /^[Mm]\s?[-+]?\.?\d/,
  _e = /^img:/,
  Be = /^svguse:/,
  Ce = /^ion-/,
  Ee = /^(fa-(classic|sharp|solid|regular|light|brands|duotone|thin)|[lf]a[srlbdk]?) /,
  Z = Q({
    name: 'QIcon',
    props: {
      ...ae,
    ...
    setup(e, { slots: t }) {
      const {
        ...
        v = i(() => {
          ...
          if (r.iconMapFn !== null) {
            const s = r.iconMapFn(l);
            if (s !== void 0)
              if (s.icon !== void 0) {
                if (((l = s.icon), l === 'none' || !l)) return { none: !0 };
          ...
          if (we.test(l) === !0) {
            ...
            return {
              ...
              nodes: s.split('&&').map((u) => {
                const [y, m, k] = u.split('@@');
                return p('path', { style: m, d: y, transform: k });
              }),
            };
          }
          ...
          let q = ' ';
          const b = l.match(qe);
          if (b !== null) c = ue[b[1]](l);
          else if (Ee.test(l) === !0) c = l;
          else if (Ce.test(l) === !0)
            c = `ionicons ion-${r.platform.is.ios === !0 ? 'ios' : 'md'}${l.substring(3)}`;
          else if (V.test(l) === !0) {
            c = 'notranslate material-symbols';
            const s = l.match(V);
            s !== null && ((l = l.substring(6)), (c += se[s[1]])), (q = l);
          } else {
            c = 'notranslate material-icons';
            const s = l.match($e);
            s !== null && ((l = l.substring(2)), (c += oe[s[1]])), (q = l);
          }
          return { cls: c, content: q };
        });
      return () => {
        const c = { class: o.value, style: n.value, 'aria-hidden': 'true' };
...
function Se(e) {
  return {
    cSize: i(() => (e.size in U ? `${U[e.size]}px` : e.size)),
...
function X(e, t, r, n) {
  ...
  const c = document.createElement('span'),
    ...
    q = ke(e),
    { left: b, top: s, width: h, height: u } = t.getBoundingClientRect(),
    y = Math.sqrt(h * h + u * u),
    m = y / 2,
    k = `${(h - y) / 2}px`,
    d = v ? k : `${q.left - b - m}px`,
    ...
    l.classList.add('q-ripple__inner--enter'),
      ...
      (S = setTimeout(() => {
        l.classList.remove('q-ripple__inner--enter'),
          ...
          (l.style.opacity = 0),
          (S = setTimeout(() => {
            c.remove(), r.abort.splice(r.abort.indexOf(L), 1);
          }, 275));
      }, 250));
  }, 50);
}
function G(e, { modifiers: t, value: r, arg: n }) {
  const o = Object.assign({}, e.cfg.ripple, t, r);
  e.modifiers = {
    early: o.early === !0,
    stop: o.stop === !0,
    center: o.center === !0,
...
const Re = me({
    ...
    beforeMount(e, t) {
      ...
      const n = {
        ...
        start(o) {
          n.enabled === !0 &&
            o.qSkipRipple !== !0 &&
            o.type === (n.modifiers.early === !0 ? 'pointerdown' : 'click') &&
            X(o, e, n, o.qKeyEvent === !0);
        },
        keystart: je((o) => {
          n.enabled === !0 &&
            o.qSkipRipple !== !0 &&
            D(o, n.modifiers.keyCodes) === !0 &&
  ...
  Te = Object.keys(ie),
  Me = { align: { type: String, validator: (e) => Te.includes(e) } };
function Pe(e) {
  return i(() => {
...
function Ke(e, t) {
  for (const r in t) {
    ...
    if (typeof n == 'string') {
      if (n !== o) return !1;
    } else if (Array.isArray(o) === !1 || o.length !== n.length || n.some((v, c) => v !== o[c]))
      return !1;
  }
  return !0;
}
...
function Ne(e, t) {
  ...
  for (const r in e) if (Fe(e[r], t[r]) === !1) return !1;
  return !0;
}
const ce = {
    to: [String, Object],
...
function Ie({ fallbackTag: e, useDisableForRouterLinkProps: t = !0 } = {}) {
  const r = W(),
    ...
    b = i(() => (q.value === !0 ? O(n.to) : null)),
    s = i(() => b.value !== null),
    h = i(() => l.value === !0 || s.value === !0),
    ...
    m = i(() => {
      ...
      const { matched: f } = b.value,
        { length: w } = f,
        _ = f[w - 1];
      if (_ === void 0) return -1;
      const C = o.$route.matched;
      if (C.length === 0) return -1;
      const E = C.findIndex(ee.bind(null, _));
      if (E !== -1) return E;
      const K = Y(f[w - 2]);
      return w > 1 && Y(_) === K && C[C.length - 1].path !== K
        ? C.findIndex(ee.bind(null, f[w - 2]))
        : E;
    }),
    k = i(() => s.value === !0 && m.value !== -1 && Ke(o.$route.params, b.value.params)),
    d = i(
      () =>
        k.value === !0 &&
        m.value === o.$route.matched.length - 1 &&
        Ne(o.$route.params, b.value.params),
    ),
    x = i(() =>
      s.value === !0
        ? d.value === !0
  ...
  function O(f) {
    try {
      return o.$router.resolve(f);
    } catch {}
    return null;
  }
  function L(f, { returnRouterError: w, to: _ = n.to, replace: C = n.replace } = {}) {
    ...
    f.preventDefault();
    const E = o.$router[C === !0 ? 'replace' : 'push'](_);
    return w === !0 ? E : E.then(() => {}).catch(() => {});
  }
  function S(f) {
    if (s.value === !0) {
      const w = (_) => L(f, _);
...
function Ze(e) {
  const t = le(e, De),
    ...
    b = i(() => e.rounded === !0 || e.fab === !0 || e.fabMini === !0),
    s = i(() => e.disable !== !0 && e.loading !== !0),
    h = i(() => (s.value === !0 ? e.tabindex || 0 : -1)),
    u = i(() => He(e, 'standard')),
    y = i(() => {
      ...
      return (
        o.value === !0
          ...
          : Ue.includes(e.type) === !0 && (d.type = e.type),
        v.value === 'a'
          ? (e.disable === !0
              ? (d['aria-disabled'] = 'true')
              : d.href === void 0 && (d.role = 'button'),
            n.value !== !0 && Qe.test(e.type) === !0 && (d.type = e.type))
    ...
    m = i(() => {
      ...
      const x =
        e.round === !0
          ? 'round'
          : `rectangle${b.value === !0 ? ' q-btn--rounded' : e.square === !0 ? ' q-btn--square' : ''}`;
      return (
...
const nt = Q({
  name: 'QBtn',
  props: { ...Ve, percentage: Number, darkPercentage: Boolean, onTouchstart: [Function, Array] },
  ...
  setup(e, { slots: t, emit: r }) {
      ...
      u.value !== null &&
        ...
        D(a, [13, 32]) === !0 &&
          ...
          a.defaultPrevented !== !0 &&
            ...
            u.value.addEventListener('blur', B, $)),
          A(a)));
    }
    function E(a) {
      u.value !== null &&
        ...
        a.defaultPrevented !== !0 &&
          (j !== u.value &&
            ...
            (j = u.value),
            (m = a.target),
            m.addEventListener('touchcancel', B, $),
            m.addEventListener('touchend', B, $)),
          (k = !0),
    ...
    function B(a) {
      if (u.value !== null && !(a?.type === 'blur' && document.activeElement === u.value)) {
        if (a?.type === 'keyup') {
          if (R === u.value && D(a, [13, 32]) === !0) {
            const g = new MouseEvent('click', a);
            (g.qKeyEvent = !0),
              a.defaultPrevented === !0 && ve(g),
              a.cancelBubble === !0 && re(g),
              u.value.dispatchEvent(g),
              A(a),
              (a.qKeyEvent = !0);
          }
          r('keyup', a);
    ...
    function M(a) {
      ...
      a !== !0 &&
        ...
        j === u.value &&
          (m !== null &&
            (m.removeEventListener('touchcancel', B, $), m.removeEventListener('touchend', B, $)),
          (j = m = null)),
        T === u.value && (document.removeEventListener('mouseup', B, $), (T = null)),
        R === u.value &&
    ...
    return (
      ...
      () => {
        let a = [];
        e.icon !== void 0 &&
          a.push(p(Z, { name: e.icon, left: e.stack !== !0 && x.value === !0, role: 'img' })),
          x.value === !0 && a.push(p('span', { class: 'block' }, [e.label])),
          (a = z(t.default, a)),
          e.iconRight !== void 0 &&
            e.round === !1 &&
            a.push(
              p(Z, { name: e.iconRight, right: e.stack !== !0 && x.value === !0, role: 'img' }),
            );
        const g = [p('span', { class: 'q-focus-helper', ref: y })];
        return (
          e.loading === !0 &&
            e.percentage !== void 0 &&
            g.push(
          ...
          fe(p(b.value, w.value, g), [[Re, O.value, void 0, L.value]])
        );
      }
    );
  },
});
export { Ae as A, Ie as I, Ye as J, Z as V, et as e, nt as n, tt as t, ze as z };
