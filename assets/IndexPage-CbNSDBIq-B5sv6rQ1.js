...
import { v as Q } from './render-Dk1QbAdB-Duum6jXv.js';
const H = b({
    name: 'QPage',
    ...
    setup(s, { slots: t }) {
      ...
      if (p(P, r) === r) return console.error('QPage needs to be child of QPageContainer'), r;
      const m = c(() => {
          const o =
            (e.header.space === !0 ? e.header.size : 0) +
            (e.footer.space === !0 ? e.footer.size : 0);
          if (typeof s.styleFn == 'function') {
            const v = e.isContainer.value === !0 ? e.containerHeight.value : n.screen.height;
            return s.styleFn(o, v);
          }
          return {
            minHeight:
        ...
        g = c(() => `q-page${s.padding === !0 ? ' q-layout-padding' : ''}`);
      return () => _('main', { class: g.value, style: m.value }, Q(t.default));
    },
  }),
      ...
      return (t, n) => (
        ...
        h(
          ...
          [
            a('div', q, [
              a('p', z, l(t.title), 1),
              a('p', F, l(t.subtitle), 1),
              a('p', $, l(t.tutorial), 1),
            ]),
            a('div', I, [a('p', J, l(t.str), 1)]),
          ],
          64,
        )
      );
  ...
  B = { class: 'button-primary' },
  E = i({
    __name: 'ButtonComponent',
    props: { buttontext: {} },
    setup(s) {
      return (t, n) => (u(), h('div', k, [a('button', B, l(t.buttontext), 1)]));
    },
  }),
  T = i({
    __name: 'IndexPage',
