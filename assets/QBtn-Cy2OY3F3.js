...
import { h as xe, c as z } from './render-Dk1QbAdB.js';
...
const W = '0 0 24 24',
  ...
  we = /^svguse:/,
  Re = /^ion-/,
  Le = /^(fa-(classic|sharp|solid|regular|light|brands|duotone|thin)|[lf]a[srlbdk]?) /,
  Y = V({
    name: 'QIcon',
    props: {
      ...re,
      ...
      const {
        ...
        f = o(() => {
          ...
          if (a.iconMapFn !== null) {
            ...
            if (s !== void 0)
              if (s.icon !== void 0) {
                if (((u = s.icon), u === 'none' || !u)) return { none: !0 };
          ...
          let q = ' ';
          const b = u.match(qe);
          if (b !== null) c = ie[b[1]](u);
          else if (Le.test(u) === !0) c = u;
          else if (Re.test(u) === !0)
            c = `ionicons ion-${a.platform.is.ios === !0 ? 'ios' : 'md'}${u.substring(3)}`;
          else if (X.test(u) === !0) {
            c = 'notranslate material-symbols';
            const s = u.match(X);
            s !== null && ((u = u.substring(6)), (c += se[s[1]])), (q = u);
          } else {
            c = 'notranslate material-icons';
            const s = u.match($e);
            s !== null && ((u = u.substring(2)), (c += le[s[1]])), (q = u);
          }
          return { cls: c, content: q };
        });
      return () => {
        const c = { class: l.value, style: n.value, 'aria-hidden': 'true' };
  ...
  Be = { size: { type: [String, Number], default: '1em' }, color: String };
function Ce(e) {
  return {
...
const _e = V({
  name: 'QSpinner',
  props: { ...Be, thickness: { type: Number, default: 5 } },
  setup(e) {
...
function G(e, t, a, n) {
  ...
  const c = document.createElement('span'),
    ...
    q = me(e),
    { left: b, top: s, width: y, height: i } = t.getBoundingClientRect(),
    k = Math.sqrt(y * y + i * i),
    h = k / 2,
    p = `${(y - k) / 2}px`,
    d = f ? p : `${q.left - b - h}px`,
  ...
  const a = U(),
    ...
    q =
      t === !0
        ...
        : o(() => c === !0 && u.value !== !0 && n.to !== void 0 && n.to !== null && n.to !== ''),
    b = o(() => (q.value === !0 ? _(n.to) : null)),
    s = o(() => b.value !== null),
    y = o(() => u.value === !0 || s.value === !0),
    i = o(() => (n.type === 'a' || y.value === !0 ? 'a' : n.tag || e || 'div')),
    k = o(() =>
      u.value === !0
    ...
    p = o(() => s.value === !0 && h.value !== -1 && Ke(l.$route.params, b.value.params)),
    d = o(
      () =>
        p.value === !0 &&
        h.value === l.$route.matched.length - 1 &&
        De(l.$route.params, b.value.params),
    ),
    x = o(() =>
      s.value === !0
        ? d.value === !0
...
const ne = { none: 0, xs: 4, sm: 8, md: 16, lg: 24, xl: 32 },
  Fe = { xs: 8, sm: 10, md: 14, lg: 20, xl: 24 },
...
function Ye(e) {
  const t = ue(e, Fe),
    ...
    b = o(() => e.rounded === !0 || e.fab === !0 || e.fabMini === !0),
      ...
      return (
        ...
        f.value === 'a'
          ? (e.disable === !0
            ...
            n.value !== !0 && Ve.test(e.type) === !0 && (d.type = e.type))
...
const nt = V({
  ...
  setup(e, { slots: t, emit: a }) {
    ...
    function w(r) {
      if (i.value !== null && !(r?.type === 'blur' && document.activeElement === i.value)) {
        if (r?.type === 'keyup') {
          if (A === i.value && F(r, [13, 32]) === !0) {
            const m = new MouseEvent('click', r);
            (m.qKeyEvent = !0),
              r.defaultPrevented === !0 && be(m),
    ...
    function M(r) {
      ...
      r !== !0 &&
        ...
        T === i.value &&
          (h !== null &&
            (h.removeEventListener('touchcancel', w, E), h.removeEventListener('touchend', w, E)),
          (T = h = null)),
        ...
        A === i.value &&
          ...
          (A = null)),
        i.value?.classList.remove('q-btn--active');
    }
    function j(r) {
      P(r), (r.qSkipRipple = !0);
    }
                ...
                e.loading === !0
                  ? [
                      v(
                        ...
                        t.loading !== void 0 ? t.loading() : [v(_e)],
                      ),
                    ]
                  : null,
              ),
            ),
          pe(v(b.value, $.value, m), [[Ae, _.value, void 0, B.value]])
        );
      }
    );
  },
});
export { Y as Q, et as a, Ne as b, Pe as c, nt as d, Ze as g, tt as u, ze as v };
