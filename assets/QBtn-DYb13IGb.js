...
import { h as xe, c as z } from './render-DAqPa2vd.js';
...
function Ne({ fallbackTag: e, useDisableForRouterLinkProps: t = !0 } = {}) {
  ...
  function L(g, { returnRouterError: $, to: S = n.to, replace: R = n.replace } = {}) {
    ...
    return (
      ...
      () => {
        ...
        return (
          ...
          pe(v(h.value, $.value, m), [[Ae, _.value, void 0, L.value]])
        );
      }
    );
  },
